...
class MarkascompletedWidget extends StatefulWidget {
  const MarkascompletedWidget({
    super.key,
    this.bookingsRef,
  });
...
class _MarkascompletedWidgetState extends State<MarkascompletedWidget> {
  late MarkascompletedModel _model;
                        ...
                        child: Row(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MARKASCOMPLETED_COMP_YES_BTN_ON_TAP');
                                ...
                                await PastbookingsRecord.collection
                                    ...
                                    .set(createPastbookingsRecordData(
                                      caregivername:
                                          optionsBookingsRecord.caregivername,
                                      clientsname:
                                          optionsBookingsRecord.clientsname,
                                      caregiversimage:
                                          optionsBookingsRecord.caregiversimage,
                                      caregiversspecialty: optionsBookingsRecord
                                          .caregiversspecialty,
                                      caregiversrating: optionsBookingsRecord
                                          .caregiversrating,
                                      orderDate:
                                          optionsBookingsRecord.orderDate,
                                      orderId: optionsBookingsRecord.orderId,
                                    ));
                                logFirebaseEvent('Button_backend_call');
                                await widget.bookingsRef!.delete();
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'MARKASCOMPLETED_COMP_NO_BTN_ON_TAP');
                                  logFirebaseEvent('Button_bottom_sheet');
                                  Navigator.pop(context);
                                },
                                text: 'No',
