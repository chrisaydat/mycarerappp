      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CaregiverdetailspageWidget(
            caregiversRef: params.getParam(
              'caregiversRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['Caregivers'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const PaymentdetailspageWidget(),
        ),
        FFRoute(
          name: 'mapviewpage',
          path: '/mapviewpage',
          builder: (context, params) => const MapviewpageWidget(),
        )
