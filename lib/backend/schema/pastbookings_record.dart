...
class PastbookingsRecord extends FirestoreRecord {
  PastbookingsRecord._(
    super.reference,
    super.data,
  ) {
    _initializeFields();
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('pastbookings');

  static Stream<PastbookingsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PastbookingsRecord.fromSnapshot(s));

  static Future<PastbookingsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => PastbookingsRecord.fromSnapshot(s));

  static PastbookingsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PastbookingsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PastbookingsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PastbookingsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PastbookingsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PastbookingsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPastbookingsRecordData({
...
class PastbookingsRecordDocumentEquality
    implements Equality<PastbookingsRecord> {
  const PastbookingsRecordDocumentEquality();

  @override
  bool equals(PastbookingsRecord? e1, PastbookingsRecord? e2) {
  ...
  @override
  int hash(PastbookingsRecord? e) => const ListEquality().hash([
        e?.client,
        e?.caregiver,
        e?.startTime,
        e?.endTime,
  ...
  @override
  bool isValidKey(Object? o) => o is PastbookingsRecord;
}
