...
class _PaymentdetailspageWidgetState extends State<PaymentdetailspageWidget> {
  late PaymentdetailspageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentdetailspageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'paymentdetailspage'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PAYMENTDETAILSarrow_back_rounded_ICN_ON_');
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(16.0, 12.0, 24.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Expanded(
