...
class _SupportpageWidgetState extends State<SupportpageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('SUPPORTsupportpage_ON_INIT_STATE');
      logFirebaseEvent('supportpage_navigate_to');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SUPPORTarrow_back_rounded_ICN_ON_TAP');
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SUPPORTContainer_ea67a94o_ON_TAP');
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SUPPORTContainer_qnvz6aox_ON_TAP');
                                    logFirebaseEvent('Container_send_email');
                                    await launchUrl(Uri(
                                        scheme: 'mailto',
                                        path: 'chrisaydat@gmail.com',
                                        query: {
                                          'subject': 'I need help',
                                        }
                                            .entries
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'What do i do if a caregiver fails to show up?',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily: 'Inter',
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 4.0, 0.0, 0.0),
                                    child: Text(
                                      'Lorem Ipsum Christian Ayeh Datey',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
