...
import '/components/markascompleted/markascompleted_widget.dart';
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TabBarView(
                          ...
                          children: [
                            Visibility(
                              visible: FFAppState().upcomingbookings == true,
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        FlutterFlowIconButton(
                                                          ...
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'BOOKINGPAGE_PAGE_convertshape_ICN_ON_TAP');
                                                            logFirebaseEvent(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'BOOKINGPAGE_PAGE_JOIN_NOW_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_launch_u_r_l');
                                                            await launchURL(
                                                                listViewBookingsRecord
                            ...
                            Visibility(
                              visible: FFAppState().pastbookings == true,
                              child: StreamBuilder<List<PastbookingsRecord>>(
                                stream: queryPastbookingsRecord(),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                  ...
                                  return InkWell(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewPastbookingsRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewPastbookingsRecord =
                                            listViewPastbookingsRecordList[
                                                listViewIndex];
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
